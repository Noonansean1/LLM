...
INDEX_NAME      = os.getenv("AZURE_SEARCH_INDEX_NAME", "demo-rag-index")
...
if __name__ == "__main__":
    ...
    # 2) Dummy data
    dummy = [
        ("RAG Basics", "Retrieval-Augmented Generation augments an LLM with retrieved context."),
        ("Azure AI Search", "Azure AI Search supports keyword, vector, and hybrid search over your data."),
        ("Customer Service", "Great support requires fast, accurate answers grounded in policy documents.")
    ]

    # 3) Embed and prepare docs
    docs = []
    for title, content in dummy:
        vec = embed(content)
